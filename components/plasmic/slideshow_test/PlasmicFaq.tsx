...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: AkOwPJYSrfOCdJ/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__iXTu)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__bhltV)}>
          <div className={classNames(projectcss.all, sty.freeBox__cZd11)}>
            {p.renderPlasmicSlot({
