...
import Avatar from "../../Avatar"; // plasmic-import: Ea8UwaDeV23XuG/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: gFRCq2hTeBSgLQ/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: LW0oOIfwzm2n7l/icon
  ...
  return (
    ...
    >
      <Avatar
        ...
        pic={
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/slideshow_test/images/profilepic.png",
              fullWidth: 192,
              fullHeight: 192,
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__qs48X)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__qzZhC)}
        >
          <div
            className={classNames(
              projectcss.all,
